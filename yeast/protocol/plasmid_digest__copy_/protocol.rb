...
class Protocol
    ...
    def main 
        ...
        mm_table = operations.start_table
            ...
            .custom_column(heading: "DI Water (l)", checkable: true) { |op| 44 - op.temporary[:plasVol] }
            .custom_column(heading: "Buffer (l)", checkable: true) { |op| 5 }
            .custom_column(heading: "Enzyme (l)", checkable: true) { |op| 1 }
            .end_table
    ...
    def add_plasmid
        ...
        show do
          ...
          table operations.start_table
            ...
            .output_item("Digested Plasmid")
            .custom_column(heading: "Volume (l)", checkable: true) { |op| op.temporary[:plasVol] }
            .end_table
        end
    end
    ...
    def incubate_digest
        ...
        show do
          ...
          check "Place the tubes into a small green tube holder and then place in 37 C incubator."
