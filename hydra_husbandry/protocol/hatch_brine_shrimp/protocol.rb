# NOTE: This protocol is migrating to the BrineShrimp library on Nursery,
# and is only retained here for reference
...
class Protocol
  ...
  def main
    ...
    show do
      ...
      bullet "Weigh #{1 * operations.length}g of brine shrimp eggs (about 1 scoop)"
    end
    ...
    show do
      ...
      bullet "Add #{1 * operations.length}g brine shrimp eggs to the hatching cone"
