...
# @params object_type [object] is the ObjectType of the container that will be used for culturing, this is necessary to calculate working volumes for all components in the culture.
# @params opts [hash] is a hash that is used for prototyping and adding addiitonal functionality without interupting core functions. Generally, not used.
# 
...
# This class instatiates formatted 'Define Culture Conditions' field values and provides specific attributes based on the SampleType of the component. 
# It formats all components in a similar fashion in order for class CultureComposition to compute necessary volumes and concentrations.
...
# This module formats FieldValues from 'Define Culture Conditions' in order for class CultureComponent to take as input and instatiate it as a CultureComponent
