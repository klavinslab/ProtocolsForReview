  ...
  def main
    ...
    operations.group_by {|op| op.input(MEASUREMENT_TYPE).val.to_sym }.each do |measurement_type, ops|
      ...
      ops.each do |op|
        ...
        # log_info 'pr.experimental_item', pr.experimental_item, 'pr.transfer_needed', pr.transfer_needed.to_s, 'pr.measurement_item', pr.measurement_item, 'dilution_factor', dilution_factor
