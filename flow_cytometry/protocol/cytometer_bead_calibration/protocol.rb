...
class Protocol
  ...
  BEAD_STOCK = 'calibration beads'.freeze
  ...
  def main
    ...
    op_groups_by_bead.each do |bead, ops|
      ...
      ops.each do |op|
        ...
        while !op.plan.get(safe_key).nil?
  ...
  def group_operations_by_bead
    ...
    operations.each do  |op| 
      ...
      if ops_by_bead[bead_stock].nil?
        ops_by_bead[bead_stock] = []
      end
  ...
  def return_beads op_groups_by_bead, cytometer
    show do
