  ...
  module Cytometer
    ...
    def check_for_diluted_beads stock
        ...
        resp = show do
            ...
            select ['yes', 'no'], label: "Could you find diluted beads from Lot no. #{lotno} that are less than one week old?", var: 'bead_answer', default: 1
