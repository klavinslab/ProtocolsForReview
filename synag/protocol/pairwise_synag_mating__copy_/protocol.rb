class Protocol
    ...
    #Note: Just add in a step to add a chemical inducer to the mating mix. 
    #Then add associations with the output item of :inducer, which is inducer "sample ID_End conc"
  ...
  def main
    ...
    def add_inputs
        ...
        show do 
            ...
            table operations.start_table
              ...
              .custom_column(heading: "Transfer") { "2.5 L" }
              .end_table
        end
         ...
         show do 
            ...
            table operations.start_table
              ...
              .output_item(OUTPUT, heading: "Output item")
              .custom_column(heading: "Transfer") { "5 L" }
              .end_table
        end
    end
    ...
    def  store_outputs
        ...
        show do 
            title "Place yeast matings in 30C Incubator"
            operations.each do |op|
                check "#{op.output(OUTPUT).item.id}"
            end
        end
