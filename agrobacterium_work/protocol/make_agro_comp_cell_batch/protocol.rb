...
class Protocol
  ...
  def main
    ...
    batch_info = show do
        title "Which Agro strain would you like to make a batch for?"
        
        select ["pSoup"], var: :strain, label: "Choose wisely:", default: 0
    ...
    show do
        ...
        note "Made Agro Comp Cell Batch of #{op.output("Batch").collection.num_samples} cells"
